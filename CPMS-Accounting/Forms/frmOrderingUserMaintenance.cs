...
{
    public partial class frmOrderingUserMaintenance : Form
    {
        ...
        Thread thread;
        public frmOrderingUserMaintenance()
        {
            InitializeComponent();
        }

        private void frmOrderingUserMaintenance_Load(object sender, EventArgs e)
        {
